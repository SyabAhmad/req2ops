...
export default function WorkspacePage({ data, onHome }) {
  ...
  return (
    <div className="py-8 sm:py-12">
      ...
      {/* Hidden container for PDF capture — renders all plans */}
      <div
        id="pdf-all-plans"
        ref={pdfContentRef}
        style={{ position: 'absolute', left: '-9999px', top: 0, width: '210mm', background: '#fff', padding: '20mm', fontFamily: 'Inter, system-ui, sans-serif' }}
      >
        <div style={{ marginBottom: '24px', borderBottom: '2px solid #e5e7eb', paddingBottom: '16px' }}>
          ...
          <p style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>Generated by Req2Ops</p>
        </div>
        {allPlanEntries.map(([planId, planData]) => (
          <div key={planId} style={{ pageBreakAfter: 'always', marginBottom: '32px' }}>
